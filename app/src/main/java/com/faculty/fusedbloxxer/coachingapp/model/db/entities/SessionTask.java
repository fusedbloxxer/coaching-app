            ...
            synchronized (SessionTask.class) {
                if (sSessionTasks == null) {
                    sSessionTasks = new SessionTask[]{
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            ...
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask(null, timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask((long) randomNumber(11), timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask((long) randomNumber(11), timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask((long) randomNumber(11), timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask((long) randomNumber(11), timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
                            new SessionTask((long) randomNumber(11), timestamp(), 1 + (long) randomNumber(Session.getFakeSessions().length), 1 + (long) randomNumber(Task.getFakeTasks().length)),
